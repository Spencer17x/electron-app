...
Page({
    ...
    switchToPhoto() {
        ...
        this.setData({cameraState: 'photo'});
    ...
    switchToRecord() {
        ...
        this.setData({cameraState: 'record'});
    ...
    touchEnd(e) {
        if (this.startX) {
            ...
            const cameraState = this.getData('cameraState');
